...
[fechamento das sentinelas](EXP-0025-R-external-sentinel-closeout.md) e o
[fechamento terminal](EXP-0025-R-external-terminal-closeout.md). O relato
abaixo permanece histórico e não foi reescrito.
