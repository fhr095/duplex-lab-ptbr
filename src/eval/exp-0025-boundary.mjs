...
export const EXP0025_FREEZE_SCHEMA =
  "exp-0025-instrumentation-freeze-v1";
export const EXP0025_OPENING_SCHEMA =
  "exp-0025-causal-render-onset-attempt-v1";
export const EXP0025_ATTEMPT_NONCE = "exp-0025-official-v0.1";

export const EXP0025_IMPLEMENTATION_BASE_COMMIT =
  "e0883a6c1958a66268dd74df09bf66c255652b09";
export const EXP0025_EXP0019_EVIDENCE_COMMIT =
  "0127322ad18a5b1d98de53d9e45898249e05888d";
export const EXP0025_EXP0023_EVIDENCE_COMMIT =
  "ee0d5864aac4a984b33c9bdb86273ca9e7283b38";
export const EXP0025_EXP0024_EVIDENCE_COMMIT =
  "5a65d155787f3875973c280c5ed8d576d69d2853";

export const EXP0025_REQUIRED_NODE_VERSION = "v22.22.2";
export const EXP0025_REQUIRED_CHROME = Object.freeze({
  product: "Chrome/150.0.7871.187",
  protocolVersion: "1.3"
});
export const EXP0025_RUNTIME_FINGERPRINT_ROOTS = Object.freeze([
  "src",
  "web",
  "package.json",
  "package-lock.json",
...
export const EXP0025_RUNTIME_FINGERPRINT_ALGORITHM =
  "sha256-source-tree-v1";

export const EXP0025_PREREGISTRATION_PATH =
  "docs/experiments/EXP-0025-causal-render-onset-physical-stop.md";
export const EXP0025_EXP0019_REPORT_PATH =
  "eval/reports/exp-0019-causal-audio-v0.1.json";
export const EXP0025_EXP0019_CLOSEOUT_PATH =
  "docs/experiments/EXP-0019-closeout.md";
export const EXP0025_EXP0023_REPORT_PATH =
  "eval/reports/exp-0023-cdp-ordinal-timestamp-semantics-v0.1.json";
export const EXP0025_EXP0023_CLOSEOUT_PATH =
  "docs/experiments/EXP-0023-closeout.md";
export const EXP0025_EXP0024_REPORT_PATH =
  "eval/reports/exp-0024-physical-stop-after-capture-qualification-v0.1.json";
export const EXP0025_EXP0024_CLOSEOUT_PATH =
  "docs/experiments/EXP-0024-closeout.md";
export const EXP0025_FREEZE_PATH =
  "eval/commitments/exp-0025-instrumentation-freeze-v0.1.json";
export const EXP0025_OPENING_PATH =
  "eval/commitments/exp-0025-causal-render-onset-attempt-v0.1.json";
export const EXP0025_RECEIPT_PATH =
  "eval/generated/exp-0025/causal-render-onset-attempt-consumed-v0.1.json";
export const EXP0025_JOURNAL_PATH =
  "eval/generated/exp-0025/causal-render-onset-journal-v0.1.ndjson";
export const EXP0025_REPORT_PATH =
  "eval/reports/exp-0025-causal-render-onset-physical-stop-v0.1.json";
export const EXP0025_LOCK_PATH =
  "eval/generated/exp-0025-causal-render-onset-attempt-v0.1.lock";
export const EXP0025_OFFICIAL_COMMAND =
  `flock --exclusive --nonblock ${EXP0025_LOCK_PATH} ` +
  "node scripts/run-exp-0025-supervisor.mjs";

export const EXP0025_PRODUCTION_SOURCE_PATHS = Object.freeze([
...
export const EXP0025_INSTRUMENTATION_SOURCE_PATHS = Object.freeze([
  ".gitignore",
  "package.json",
  "scripts/freeze-exp-0025-instrumentation.mjs",
  "scripts/lib/exp-0025-browser-harness.mjs",
  "scripts/lib/exp-0025-browser-trial.mjs",
  "scripts/open-exp-0025-causal-render-onset-attempt.mjs",
  "scripts/run-exp-0025-supervisor.mjs",
  "scripts/run-exp-0025-worker.mjs",
  "src/eval/exp-0025-boundary.mjs",
  "src/eval/exp-0025-journal.mjs",
  "src/eval/exp-0025-stop-order.mjs",
  "tests/exp-0025-boundary.test.mjs",
  "tests/exp-0025-browser-harness.test.mjs",
  "tests/exp-0025-browser-trial.test.mjs",
  "tests/exp-0025-journal.test.mjs",
  "tests/exp-0025-stop-order.test.mjs",
  "tests/exp-0025-supervisor.test.mjs",
  "tests/exp-0025-worker.test.mjs"
].toSorted());

export const EXP0025_C0_CHANGED_PATHS = Object.freeze([
  ...EXP0025_INSTRUMENTATION_SOURCE_PATHS
]);

export const EXP0025_RUNTIME_ALLOWED_DRIFT_PATHS = Object.freeze([
  "package.json",
  "src/eval/exp-0025-boundary.mjs",
  "src/eval/exp-0025-journal.mjs",
  "src/eval/exp-0025-stop-order.mjs"
...
export const EXP0025_GIT_TOPOLOGY = deepFreeze({
  order: ["C0_INSTRUMENT", "FREEZE", "OPENING", "EVIDENCE"],
  freezeDirectParent: "C0_INSTRUMENT",
  freezeAllowedPaths: [EXP0025_FREEZE_PATH],
  openingDirectParent: "FREEZE",
  openingAllowedPaths: [EXP0025_OPENING_PATH],
...
export const EXP0025_CONFIG = deepFreeze({
  targetUrl: "http://localhost:4173/?automation=1&experiment=0025",
  navigations: 2,
  ...
  chrome: EXP0025_REQUIRED_CHROME,
  provider: "local",
  asrState: "disabled",
...
export function validateExp0025C0Boundary(input = {}) {
  return exactKeys(input, [
    ...
    input.parentCommit === EXP0025_IMPLEMENTATION_BASE_COMMIT &&
    isDeepStrictEqual(input.changedPaths, EXP0025_C0_CHANGED_PATHS) &&
    isDeepStrictEqual(
...
export function validateExp0025FreezeCommitBoundary(input = {}) {
  return exactKeys(input, [
    ...
    isDeepStrictEqual(input.changedPaths, [EXP0025_FREEZE_PATH]);
}

export function validateExp0025OpeningCommitBoundary(input = {}) {
  return exactKeys(input, [
    ...
    isDeepStrictEqual(input.changedPaths, [EXP0025_OPENING_PATH]);
}

export function validateExp0025EvidenceCommitBoundary(input = {}) {
  if (!exactKeys(input, [
    "changedPaths",
    "evidenceCommit",
    "openingCommit",
  ...
  const allowed = input.recoveryBeforeJournal
    ...
    : EXP0025_GIT_TOPOLOGY.normalEvidenceAllowedPaths;
...
function sourceBaseline() {
  return {
    physicalRuntime: {
      ...
      evidenceCommit: EXP0025_EXP0019_EVIDENCE_COMMIT
    },
    captureQualification: {
      experimentId: "EXP-0023",
      evidenceCommit: EXP0025_EXP0023_EVIDENCE_COMMIT
    },
    renderOnsetFailure: {
      experimentId: "EXP-0024",
      evidenceCommit: EXP0025_EXP0024_EVIDENCE_COMMIT
    }
  };
}
...
function implementationBoundary() {
  return {
    baseCommit: EXP0025_IMPLEMENTATION_BASE_COMMIT,
    c0ChangedPaths: structuredClone(EXP0025_C0_CHANGED_PATHS),
    runtimeBaselineCommit: EXP0025_IMPLEMENTATION_BASE_COMMIT,
...
function freezeCore(input) {
  return {
    schemaVersion: EXP0025_FREEZE_SCHEMA,
    experimentId: "EXP-0025",
    status: "frozen-before-causal-render-onset-opening",
    ...
    config: structuredClone(EXP0025_CONFIG),
    configCanonicalSha256: `sha256:${canonicalSha256(EXP0025_CONFIG)}`,
    ...
    gitTopology: structuredClone(EXP0025_GIT_TOPOLOGY),
...
export function createExp0025InstrumentationFreeze(input = {}) {
  ...
  if (!validation.valid) {
    throw new TypeError(
      `freeze EXP-0025 inválido: ${validation.errors.join("; ")}`
    );
  }
  return freeze;
}

export function validateExp0025InstrumentationFreeze(freeze) {
  const errors = [];
  try {
    if (!exactKeys(freeze, [
      "artifacts",
      ...
      "sourceBaseline",
      "status"
    ]) || freeze?.schemaVersion !== EXP0025_FREEZE_SCHEMA ||
      freeze?.experimentId !== "EXP-0025" ||
      freeze?.status !== "frozen-before-causal-render-onset-opening" ||
      !commit(freeze?.runnerSourceCommit) ||
      freeze?.nodeVersion !== EXP0025_REQUIRED_NODE_VERSION
    ...
    if (!isDeepStrictEqual(freeze?.config, EXP0025_CONFIG) ||
      freeze?.configCanonicalSha256 !==
        `sha256:${canonicalSha256(EXP0025_CONFIG)}`
    ...
    if (!exactKeys(freeze?.artifacts, [
      ...
      EXP0025_PREREGISTRATION_PATH
    ) || !artifactValid(
      freeze?.artifacts?.exp0019Report,
      EXP0025_EXP0019_REPORT_PATH
    ) || !artifactValid(
      freeze?.artifacts?.exp0019Closeout,
      EXP0025_EXP0019_CLOSEOUT_PATH
    ) || !artifactValid(
      freeze?.artifacts?.exp0023Report,
      EXP0025_EXP0023_REPORT_PATH
    ) || !artifactValid(
      freeze?.artifacts?.exp0023Closeout,
      EXP0025_EXP0023_CLOSEOUT_PATH
    ) || !artifactValid(
      freeze?.artifacts?.exp0024Report,
      EXP0025_EXP0024_REPORT_PATH
    ) || !artifactValid(
      freeze?.artifacts?.exp0024Closeout,
      EXP0025_EXP0024_CLOSEOUT_PATH
    ...
    if (!isDeepStrictEqual(freeze?.gitTopology, EXP0025_GIT_TOPOLOGY)) {
...
function preflightValid(preflight, expectedRuntimeFingerprintSha256) {
  return exactKeys(preflight, [
    ...
    preflight.nodeVersion === EXP0025_REQUIRED_NODE_VERSION &&
    isDeepStrictEqual(preflight.chrome, EXP0025_REQUIRED_CHROME) &&
...
function attemptCampaign() {
  return {
    nonce: EXP0025_ATTEMPT_NONCE,
    command: EXP0025_OFFICIAL_COMMAND,
    targetUrl: EXP0025_CONFIG.targetUrl,
    navigations: EXP0025_CONFIG.navigations,
    stopsPerNavigation: EXP0025_CONFIG.stopsPerNavigation,
    totalStops: EXP0025_CONFIG.totalStops,
    provider: EXP0025_CONFIG.provider,
    attemptDeadlineMs: EXP0025_CONFIG.attemptDeadlineMs,
    configCanonicalSha256: `sha256:${canonicalSha256(EXP0025_CONFIG)}`,
    openingPath: EXP0025_OPENING_PATH,
    receiptPath: EXP0025_RECEIPT_PATH,
    journalPath: EXP0025_JOURNAL_PATH,
    reportPath: EXP0025_REPORT_PATH,
    lockPath: EXP0025_LOCK_PATH,
    rerunAllowed: false
  };
}
...
function attemptCore(input) {
  return {
    schemaVersion: EXP0025_OPENING_SCHEMA,
    experimentId: "EXP-0025",
    status: "opened-single-causal-render-onset-attempt",
...
export function createExp0025PhysicalStopAttempt(input = {}) {
  const core = attemptCore(input);
  const attempt = deepFreeze({
    ...core,
    physicalStopAttemptSha256: `sha256:${canonicalSha256(core)}`
  });
  const validation = validateExp0025PhysicalStopAttempt(attempt);
  if (!validation.valid) {
    throw new TypeError(
      `tentativa EXP-0025 inválida: ${validation.errors.join("; ")}`
    );
  }
  return attempt;
}

export function validateExp0025PhysicalStopAttempt(attempt) {
  const errors = [];
  try {
    if (!exactKeys(attempt, [
      ...
      "schemaVersion",
      "status"
    ]) || attempt?.schemaVersion !== EXP0025_OPENING_SCHEMA ||
      attempt?.experimentId !== "EXP-0025" ||
      attempt?.status !== "opened-single-causal-render-onset-attempt" ||
    ...
    if (!exactKeys(attempt?.freeze, [
      ...
      "path",
      "runnerSourceCommit"
    ]) || attempt?.freeze?.path !== EXP0025_FREEZE_PATH ||
      ...
      attempt?.freeze?.nodeVersion !== EXP0025_REQUIRED_NODE_VERSION ||
    ...
    if (!isDeepStrictEqual(attempt?.gitTopology, EXP0025_GIT_TOPOLOGY)) {
...
export const EXP0025_BOUNDARY_PATHS = deepFreeze({
  preregistration: EXP0025_PREREGISTRATION_PATH,
  exp0019Report: EXP0025_EXP0019_REPORT_PATH,
  exp0019Closeout: EXP0025_EXP0019_CLOSEOUT_PATH,
  exp0023Report: EXP0025_EXP0023_REPORT_PATH,
  exp0023Closeout: EXP0025_EXP0023_CLOSEOUT_PATH,
  exp0024Report: EXP0025_EXP0024_REPORT_PATH,
  exp0024Closeout: EXP0025_EXP0024_CLOSEOUT_PATH,
  freeze: EXP0025_FREEZE_PATH,
  opening: EXP0025_OPENING_PATH,
  receipt: EXP0025_RECEIPT_PATH,
  journal: EXP0025_JOURNAL_PATH,
  report: EXP0025_REPORT_PATH,
  lock: EXP0025_LOCK_PATH
});
